...
export const contactPageServices = [
...
export const emergencyContact = {
  ...
  description:
    "If you're experiencing an active security incident, our incident response team is available 24/7.",
  phone: "+91-7439490434",
  email: "incident@itorigin.in",
  cta: "Report Incident",
};
...
export const faq = [
  {
    ...
    answer:
      "We aim to respond to all inquiries within 24 business hours. For urgent security matters, please call our emergency hotline.",
  },
  {
    id: 2,
    question: "Do you offer free security assessments?",
    answer:
      "Yes, we offer complimentary initial security assessments to help you understand your security posture and how we can help.",
  },
  {
    id: 3,
    question: "Can you provide services to organizations outside India?",
    answer:
      "Yes, we serve clients globally. Our SOC operates 24/7 and can support organizations in any timezone.",
  },
  {
    id: 4,
    question: "How do I become a partner?",
    answer:
      "Visit our Partner page to learn about our partner programs and fill out the partner application form.",
  },
];
