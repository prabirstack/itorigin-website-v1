...
export const services: Service[] = [
  {
    ...
    benefits: [
      { title: "Reduce Risk", description: "Proactive threat detection minimizes your attack surface", icon: "ShieldCheck" },
      { title: "Save Costs", description: "Avoid the expense of building an in-house SOC", icon: "PiggyBank" },
      { title: "Expert Team", description: "Access to certified security professionals 24/7", icon: "Users" },
      { title: "Compliance", description: "Meet regulatory requirements with comprehensive reporting", icon: "FileCheck" },
    ],
  ...
  },
  {
    ...
    benefits: [
      { title: "Find Vulnerabilities", description: "Discover security gaps before attackers do", icon: "Search" },
      { title: "Validate Controls", description: "Test effectiveness of your security measures", icon: "CheckCircle" },
      { title: "Compliance", description: "Meet PCI-DSS, HIPAA, and other requirements", icon: "FileCheck" },
      { title: "Remediation Support", description: "Get detailed guidance on fixing vulnerabilities", icon: "Wrench" },
    ],
    pricing: { type: "contact" },
  ...
  },
  {
    ...
    benefits: [
      { title: "Faster Certification", description: "Streamlined approach to achieve compliance quickly", icon: "Zap" },
      { title: "Risk Reduction", description: "Identify and mitigate organizational risks", icon: "Shield" },
      { title: "Business Enablement", description: "Meet customer and partner security requirements", icon: "TrendingUp" },
      { title: "Expert Guidance", description: "Navigate complex regulatory requirements with ease", icon: "Compass" },
    ],
    pricing: { type: "contact" },
  ...
  },
  {
    ...
    benefits: [
      { title: "Real-World Testing", description: "Simulate actual attack scenarios", icon: "Target" },
      { title: "Comprehensive Coverage", description: "Test all aspects of your security", icon: "Layers" },
      { title: "Actionable Results", description: "Get clear remediation priorities", icon: "ListChecks" },
      { title: "Compliance", description: "Meet regulatory testing requirements", icon: "FileCheck" },
    ],
    pricing: { type: "contact" },
  ...
  },
  {
    ...
    benefits: [
      { title: "Visibility", description: "Understand your security posture", icon: "Eye" },
      { title: "Prioritization", description: "Focus on the most critical vulnerabilities", icon: "ArrowUp" },
      { title: "Efficiency", description: "Automated scanning saves time and resources", icon: "Zap" },
      { title: "Compliance", description: "Meet scanning requirements for PCI-DSS, etc.", icon: "FileCheck" },
    ],
    pricing: { type: "contact" },
  ...
  },
  {
    ...
    benefits: [
      { title: "Independent Review", description: "Unbiased assessment of your security", icon: "Scale" },
      { title: "Identify Gaps", description: "Find weaknesses before they're exploited", icon: "Search" },
      { title: "Improve Posture", description: "Get actionable recommendations", icon: "TrendingUp" },
      { title: "Board Reporting", description: "Executive-level security insights", icon: "BarChart" },
    ],
    pricing: { type: "contact" },
...
export const servicesPageHero = {
  ...
  description:
    "From 24/7 threat monitoring to compliance consulting, we provide end-to-end security services to protect your organization against evolving cyber threats.",
};

export const servicesPageSectionHeaders = {
  services: {
    title: "Security Services",
    description:
      "Choose from our comprehensive range of cybersecurity services designed to protect, detect, and respond to threats.",
  },
  whyChoose: {
    title: "Why Choose ITOrigin",
    description:
      "Partner with a trusted cybersecurity provider that delivers measurable results.",
  },
  industries: {
    title: "Industries We Serve",
    description:
      "Tailored security solutions for organizations across diverse sectors.",
  },
};
...
export const servicesPageCards = [
  {
    ...
    title: "Managed SOC Services",
    description:
      "24/7 security operations center with advanced threat detection, real-time monitoring, and rapid incident response capabilities to protect your organization around the clock.",
  ...
  },
  {
    ...
    title: "Offensive Security",
    description:
      "Proactive security testing through red team operations, adversary simulation, and advanced attack techniques to identify vulnerabilities before malicious actors do.",
  ...
  },
  {
    ...
    title: "Penetration Testing",
    description:
      "Comprehensive security assessments of your web applications, networks, APIs, and cloud infrastructure by OSCP-certified ethical hackers.",
  ...
  },
  {
    ...
    title: "Vulnerability Assessment",
    description:
      "Systematic identification and prioritization of security weaknesses across your infrastructure with actionable remediation guidance.",
  ...
  },
  {
    ...
    title: "GRC Services",
    description:
      "Expert governance, risk management, and compliance consulting to help you meet regulatory requirements and implement security frameworks.",
  ...
  },
  {
    ...
    description:
      "Thorough security audits and assessments to evaluate your security posture, identify gaps, and ensure compliance with industry standards.",
...
export const servicesPageIndustries = [
  "Financial Services",
  "Healthcare",
  "Technology",
  "Manufacturing",
...
export const servicesPageCTA = {
  ...
  buttons: [
    ...
    { text: "View Case Studies", href: "/case-studies", primary: false },
  ],
};

// Individual service page data
export * from "./penetration-testing-data";
export * from "./vulnerability-assessment-data";
